...
import { ArrowRight, CalendarCheck, Pause, Play, Star, Volume2, VolumeX } from "lucide-react";
...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="animate-hero-in delay-4 absolute bottom-5 left-4 z-20 flex items-center gap-1 rounded-full border border-primary-foreground/15 bg-deep/40 p-1 backdrop-blur-md md:bottom-7 md:left-auto md:right-8">
        <Button
          type="button"
          variant="ghost"
          size="icon"
          className="size-9 rounded-full text-primary-foreground/70 hover:bg-primary-foreground/10 hover:text-primary-foreground"
          onClick={togglePlay}
